...
function inicio2(EtapasMSG, WHATSAPP_API_TOKEN) {
  ...
  if (EtapasMSG.length > 0) {
    ...
    if (body.length > 1 && etapa === 0) {
      ...
      axios
        .post(`https://graph.facebook.com/v19.0/301766666358432/messages`, payload, {
          headers: {
